...
<<div class="content-wrapper mr-2">
    <div class="row justify-content-between px-4 pt-4">
        <h5 class="text-center">Edit Rumah Sakit</h5>
    </div>
    <hr>
    ...
    <form action="{{ route('updateRumahSakit', $rumahSakit->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3 ml-3">
        ...
        <div class="mb-3 ml-3">
            ...
            <input type="text" name="alamat" id="alamat" class="form-control" value="{{ $rumahSakit->alamat }}">
            @error('alamat')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3 ml-3">
            ...
            <input type="email" name="email" id="email" class="form-control" value="{{ $rumahSakit->email }}">
            @error('email')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3 ml-3">
            ...
            <input type="number" name="telepon" id="telepon" class="form-control" value="{{ $rumahSakit->telepon }}">
            @error('telepon')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
